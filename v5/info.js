...
function infoInit(){
	...
	infoItemAdd("moveView.transfomedPoints", false,    4, "pontos transformados do objeto em destaque (no Espaço da Câmera)");
	...
	//bits para função drawObject...View()
	infoItemAdd("topView.transfomedPoints", true, 4, "pontos transformados do objeto em destaque (no Espaço da Câmera)");
	...
	//bits para função drawObject...View()
	infoItemAdd("sideView.transfomedPoints", true, 4, "pontos transformados do objeto em destaque (no Espaço da Câmera)");
...
function infoItemAdd(key, val, bit, desc){ // nome, valor, bit, descrição         o nome é um objeto até três níveis   a.b.c = valor
	let div, inp, lab;
