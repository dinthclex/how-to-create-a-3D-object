...
function transformInit(){
	...
	transformPropertyAdd("scaleX", "X", scene.object.scale.x, 0.1, "" );
	transformPropertyAdd("scaleY", "Y", scene.object.scale.y, 0.1, "" );
	transformPropertyAdd("scaleZ", "Z", scene.object.scale.z, 0.1, "" );
}
